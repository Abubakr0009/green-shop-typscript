...
export default function Address() {
    ...
    const [user, setUser] = useState<User>(storedUser.user || {});
    const [billingAddress, setBillingAddress] = useState<BillingAddress>(user.billing_address || {});

    useEffect(() => {
        localStorage.setItem("user", JSON.stringify({ user }));
    }, [user]);

    const handleInputChange = (e: ChangeEvent<HTMLInputElement>, field: string, isBilling = false) => {
